...
test_expect_success 'verify upstream fields in branch header' '
	...
	git clone . sub_repo &&
	(
		## Confirm local main tracks remote main.
		cd sub_repo &&
		...
		## Test upstream-gone case. Fake this by pointing origin/main at
